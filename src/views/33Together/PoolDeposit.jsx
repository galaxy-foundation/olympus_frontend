          ...
          <Box display="flex" alignItems="center" flexDirection={`${isMobileScreen ? "column" : "row"}`}>
            ...
            {address && hasAllowance("sohm") ? (
              <Button
                ...
                fullWidth
              >
                {txnButtonText(pendingTransactions, "pool_deposit", "Deposit sPIP")}
              </Button>
            ) : (
              <Button
                className="pool-deposit-button"
          ...
          {newOdds > 0 && quantity > 0 && (
            <Box padding={1}>
              <Typography variant="body2" style={{ color: "#33BB33" }}>
                Depositing {quantity} sPIP will increase odds of winning to 1 in {newOdds}&nbsp;
              </Typography>
            </Box>
          )}
            ...
            <div className="data-row">
              ...
              <Typography variant="body1" align="right">
                {isAppLoading ? (
                  ...
                  <>{new Intl.NumberFormat("en-US").format(sohmBalance)} sPIP</>
                )}
              </Typography>
            </div>
          </div>
